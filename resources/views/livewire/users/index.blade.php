                ...
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">First
                                    Name
                                </th>
                                ...
                                <tr class="odd:bg-white even:bg-slate-50">
                                    ...
                                    <td class="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <a href="{{ route ('users.show', ['user' => $user->id]) }}"
                                           class="mx-1 text-indigo-600 hover:text-indigo-900">View<span
                                                    class="sr-only"></span></a>
                                        <a href="{{ route ('users.edit', ['user' => $user->id]) }}"
                                           class="mx-1 text-indigo-600 hover:text-indigo-900">Edit<span
                                                    class="sr-only"></span></a>
                                        <a href="#" wire:click="delete({{ $user->id }})"
                                           class="mx-1 text-red-500 hover:text-indigo-900">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
